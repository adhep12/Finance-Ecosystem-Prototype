...
const CANONICAL_FIELDS = {
  ...
  patron: [
    ...
    { field: 'recurring_giving_total',   label: 'Recurring Giving Total',   required: false, description: 'Total recurring giving (no $ symbol)' },
    { field: 'spontaneous_giving_total', label: 'Spontaneous Giving Total', required: false, description: 'Total spontaneous giving (no $ symbol)' },
    { field: 'avg_gift_size',            label: 'Avg Gift Size',            required: false, description: 'Average gift size (no $ symbol)' },
    { field: 'retention_rate',           label: 'Retention Rate',           required: false, description: 'Patron retention rate as decimal, e.g. 0.82' },
  ],
  cashflow: [
    { field: 'period',              label: 'Period',              required: true,  description: 'Month in YYYY-MM format, e.g. 2025-10' },
    { field: 'cash_balance',        label: 'Cash Balance',        required: true,  description: 'Month-end cash balance (no $ symbol)' },
    { field: 'prior_month_balance', label: 'Prior Month Balance', required: false, description: 'Prior month ending balance (no $ symbol)' },
    { field: 'prior_year_balance',  label: 'Prior Year Balance',  required: false, description: 'Same month prior year ending balance (no $ symbol)' },
    { field: 'reserve_floor',       label: 'Reserve Floor',       required: false, description: 'Period override for reserve floor; uses org setting if blank' },
  ],
}
