...
export const mockComments = [
  ...
  },
  {
    ...
    avatar: "J",
    page: "breakdown",
    text: "Travel spend is tracking well under budget ($18K under YTD) largely because the March product summit was moved to a virtual format. This savings may be used to offset Q4 conference attendance.",
  ...
  },
  {
    ...
    avatar: "J",
    page: "breakdown",
    text: "Budget request: $15,000 additional for the Design Tools category (Q4) to cover expanded Figma seats for 5 new contractors starting in June. Current seats will be 20% over-subscribed by end of May.",
