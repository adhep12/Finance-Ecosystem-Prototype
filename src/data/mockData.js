...
export const mockComments = [
  {
    id: "c1",
    author: "Alex H.", avatar: "A",
    page: "briefing",
    type: "financial-highlight",
  ...
  {
    id: "c2",
    author: "Jordan M.", avatar: "J",
    page: "briefing",
    type: "budget-request",
    text: "Request: Can we get a breakdown of the Computers category showing purchases by employee vs shared equipment? Need this before the Q4 budget review.",
  ...
  {
    id: "c3",
    author: "Sam T.", avatar: "S",
    page: "breakdown",
    type: "financial-highlight",
    text: "The Content Square annual renewal in February was approved in Q4 budget review. Not an overage — this was planned and signed off by leadership.",
    timestamp: "2026-03-10T11:05:00Z",
    category: "Contract",
    status: "resolved",
    anchor: { type: "tx", txRef: { date: "2026-02-01", vendor: "Content Square Inc.", amount: 108000, department: "101" } },
    teamId: 1,
  },
  {
    id: "c4",
    ...
    page: "briefing",
    type: "question",
    text: "Should we be concerned about the Computers budget? We're tracking $320K over. Is this a one-time catch-up or ongoing?",
  ...
  },
  {
    ...
    page: "breakdown",
    type: "financial-highlight",
    text: "Cloud infrastructure costs have stayed under budget every month this fiscal year — strong optimization work from the Engineering team. AWS reserved instances are saving roughly $4K/month vs on-demand rates.",
  ...
  },
  {
    ...
    page: "breakdown",
    type: "financial-highlight",
    text: "Travel spend is tracking well under budget ($18K under YTD) largely because the March product summit was moved to a virtual format. This savings may offset Q4 conference attendance.",
  ...
  },
  {
    ...
    author: "Sam T.", avatar: "S",
    page: "breakdown",
    type: "variance-explanation",
    text: "The Computers category is $320K over budget because we pulled forward the annual hardware refresh from Q1 FY2027 into November 2025 to take advantage of bulk pricing. The overage is offset by deferred spend next fiscal year.",
    timestamp: "2026-04-18T09:00:00Z",
    category: "Computers",
    status: "open",
    anchor: { type: "tx", txRef: { date: "2025-11-03", vendor: "Dell Technologies", amount: 68000, department: "101" } },
    teamId: 1,
  },
  {
    id: "c8",
    ...
    page: "breakdown",
    type: "budget-request",
    text: "$15,000 additional for Design Tools (Q4) to cover expanded Figma seats for 5 new contractors starting in June. Current seats will be 20% over-subscribed by end of May.",
  ...
  },
  {
    ...
    text: "The $6,750 MUX charge in October should be reclassified from Platform Contracts to Software Subscriptions to align with our updated GL coding policy. Please update in the next import.",
    timestamp: "2026-05-12T15:45:00Z",
    category: "Contract",
    status: "open",
    anchor: { type: "tx", txRef: { date: "2025-10-18", vendor: "MUX Inc.", amount: 6750, department: "101" } },
    teamId: 1,
  },
  {
    id: "c10",
    ...
    page: "breakdown",
    type: "question",
    text: "Is this a one-time renewal or recurring annual? We had something similar last quarter — want to make sure we are not double-paying.",
    timestamp: "2026-05-18T08:30:00Z",
    category: "Software",
    status: "open",
    anchor: { type: "tx", txRef: { date: "2025-10-09", vendor: "Microsoft 365", amount: 5800, department: "101" } },
    teamId: 1,
  },
  {
    id: "c11",
    ...
    page: "briefing",
    type: "variance-explanation",
    text: "The October spike in overall spend (+141% vs monthly avg) is a combination of the Q4 hardware refresh and annual SaaS renewals all landing in the same month. This is expected seasonality for our team.",
